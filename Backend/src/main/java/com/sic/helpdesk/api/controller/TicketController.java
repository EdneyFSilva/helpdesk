package com.sic.helpdesk.api.controller;
...
import com.sic.helpdesk.api.dto.Summary;
...
import com.sic.helpdesk.api.enums.StatusEnum;
import com.sic.helpdesk.api.response.Response;
...
public class TicketController {
	...
	public ResponseEntity<Response<Ticket>> findById(@PathVariable("id") String id) {
		...
		if (ticket == null) {
			response.getErrors().add("Register no found id: "+id);
			return ResponseEntity.badRequest().body(response);
		}
	...
	public ResponseEntity<Response<Ticket>> changeStatus(@PathVariable("id") String id,
		...
		Response<Ticket> response = new Response<Ticket>();
		try {
			validateUpdateChangeStatus(id, status, result);
			if(result.hasErrors()) {
				result.getAllErrors().forEach(error -> response.getErrors().add(error.getDefaultMessage()));
				return ResponseEntity.badRequest().body(response);
			}
	...
	private void validateUpdateChangeStatus(String id, String status, BindingResult result) {
