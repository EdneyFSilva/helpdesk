...
public interface TicketRepository extends MongoRepository<Ticket, String> {
	...
	Page<Ticket> findByTitleIgnoreCaseContainingAndStatusAndPriorityAndAssignedUserIdOrderByDateDesc(String title, String status, String priority, String userId, Pageable pages);
